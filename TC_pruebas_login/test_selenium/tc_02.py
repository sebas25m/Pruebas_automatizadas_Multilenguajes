...
def tomar_screenshot(driver, screen_name: str):
    global counter
    driver.save_screenshot(f"TC_pruebas_login/test_selenium/test_images/tc_02_{screen_name}_{counter}.png")
    counter += 1
...
tomar_screenshot(driver, "inicio_fallido")
time.sleep(1)

driver.find_element(By.XPATH, uname_input).send_keys("Mi_Prueba")
driver.find_element(By.XPATH, pw_input).send_keys("HolaMundo!")
